import RaxLowcodeTestMeta from '/Users/lym/Desktop/LowCode/rax-lowcode-single-demo/lowcode/rax-lowcode-test/meta'
...
function fillRealVersion(meta, packageName = 'rax-lowcode-test', version = '0.0.1-beta.16', basicLibraryVersion={"@alifd/next":"1.25.23","@alifd/meet":"2.6.3","antd":"4.17.3"}) {
  if (!meta || !version) {
    return meta;
  }
  const { npm } = meta;
...
const componentMetas = [RaxLowcodeTestMeta];
const components = [];
...
if (!execCompile) {
  window.RaxLowcodeTestMeta = { components, componentList };
}